...
def get_credentials_file():
    ...
    if json_str and json_str.strip().startswith("{"):
        tmp_file = "/tmp/credentials.json"
        with open(tmp_file, "w") as f:
            f.write(json_str)
        return tmp_file
    raise Exception("Google credentials file not found. Set GOOGLE_CREDENTIALS_FILE to a valid path or GOOGLE_CREDENTIALS_JSON to the JSON string.")
