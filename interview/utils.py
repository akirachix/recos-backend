...
class GoogleCalendarService:
   ...
   def get_oauth_client_config(cls):
       ...
       if cls.is_production():
           redirect_uri = os.environ.get('GOOGLE_REDIRECT_URI', 'https://recos-7bb46015fb57.herokuapp.com/auth/google/callback/')
       else:
       ...
       return {
           "web": {
               ...
               "javascript_origins": [os.environ.get('SITE_DOMAIN', 'https://recos-7bb46015fb57.herokuapp.com')],
           }
       }
   ...
   def get_redirect_uri(cls, request):
       ...
       if cls.is_production():
           return os.environ.get('GOOGLE_REDIRECT_URI', 'https://recos-7bb46015fb57.herokuapp.com/auth/google/callback/')
       else:
